...
A ~2400 ELO chess engine written in C++17. Single binary, no dependencies, no internet required. Built-in web UI with drag-and-drop play, clock, move history, and live eval — or connect it to any UCI GUI. Multi-threaded search, Syzygy tablebases, opening book, the works.
